...
public class ScriptDebugger extends JDialog {
    ...
    public ScriptDebugger(final Interpreter it) {
        ...
        toolsbar.add(new Icon25x25Button(
                new DebugAction(STOP, Util.getIcon("/icons/stop2.gif"), STOP)));
        toolsbar.add(new Icon25x25Button(
                new DebugAction(STEPOUT, Util.getIcon("/icons/stepout.gif"), STEPOUT)));
        toolsbar.add(Box.createHorizontalStrut(20));
        toolsbar.add(new Icon25x25Button(
                new DebugAction(WATCH, Util.getIcon("/icons/watch.gif"), WATCH)));
