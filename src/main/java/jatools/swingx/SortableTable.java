...
public class SortableTable extends JPanel implements ListSelectionListener {
    ...
    public SortableTable(JTable t, int buttons) {
        ...
        if ((buttons & NEW) != 0) {
            bar.add(newButton = new FixedSizeButton(Util.getIcon("/icons/new.gif"), null,
                        ICON_SIZE, ICON_SIZE));
        }

        if ((buttons & DELETE) != 0) {
            deleteButton = new FixedSizeButton(Util.getIcon("/icons/delete.gif"), null,
                    ICON_SIZE, ICON_SIZE);
        ...
        if ((buttons & UP) != 0) {
            upButton = new FixedSizeButton(Util.getIcon("/icons/up.gif"), null, ICON_SIZE,
                    ICON_SIZE);
        ...
        if ((buttons & DOWN) != 0) {
            downButton = new FixedSizeButton(Util.getIcon("/icons/down.gif"), null,
                    ICON_SIZE, ICON_SIZE);
