...
public class MoveController extends JPanel {
    ...
    public MoveController(Moveable leftMoveable, Moveable rightMoveable, int options) {
        ...
        if ((options & SELECT) != 0) {
            b = new JButton(Util.getIcon("/icons/select.gif")); //
        ...
        if ((options & SELECT_ALL) != 0) {
            b = new JButton(Util.getIcon("/icons/selectall.gif")); //
            b.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
                        moveAll();
                    }
        ...
        if ((options & UNSELECT) != 0) {
            b = new JButton(Util.getIcon("/icons/unselect.gif")); //
            b.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
                        moveBack();
                    }
        ...
        if ((options & UNSELECT_ALL) != 0) {
            b = new JButton(Util.getIcon("/icons/unselectall.gif")); //
