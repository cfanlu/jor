...
public abstract class AbstractNode extends DefaultMutableTreeNode {
    static final Icon JAR_ICON = Util.getIcon("/icons/jarfile.gif");
    static final Icon CLASS_ICON = Util.getIcon("/icons/class.gif");
    static final Icon LIB_ICON = Util.getIcon("/icons/library.gif");
    static final Icon STATIC_ICON = Util.getIcon("/icons/static.gif");
    static final Icon PUBLIC_ICON = Util.getIcon("/icons/publicmethod.gif");
    public static final Icon CHECKED_ICON = Util.getIcon("/icons/checked.gif");
    public static final Icon NO_CHECK_ICON = Util.getIcon("/icons/nocheck.gif");
