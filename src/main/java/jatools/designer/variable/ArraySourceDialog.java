...
public class ArraySourceDialog extends JDialog implements ActionListener {
    ...
    static final Icon icon = Util.getIcon("/icons/class.gif");
    ...
    private JPanel editor() {
        ...
        //        bar.add(createButton(Util.getIcon("/com/icons/new.gif"), "新建", NEWACTION));
        //        bar.add(createButton(Util.getIcon("/com/icons/new.gif"), "插入常用数组", INSERTACTION));
        //     //   bar.add(createButton(Util.getIcon("/com/icons/new.gif"), "合法性检测", VALIDATEACTION));
        //        bar.add(createButton(Util.getIcon("/com/icons/new.gif"), "高级", BEANACTION));
