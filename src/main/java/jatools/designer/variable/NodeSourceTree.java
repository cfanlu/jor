...
public class NodeSourceTree extends JTree implements NameChecker, DragSourceListener,
    ...
    static Icon root_icon = Util.getIcon("/icons/datatree/root.gif");
    static Icon dataset_icon = Util.getIcon("/icons/datatree/dataset.gif");
    static Icon index_icon = Util.getIcon("/icons/datatree/index.gif");
    static Icon cross_icon = Util.getIcon("/icons/datatree/cross.gif");
    static Icon row_icon = Util.getIcon("/icons/datatree/row.gif");
    static Icon group_icon = Util.getIcon("/icons/datatree/group.gif");
    static Icon xml_icon = Util.getIcon("/icons/datatree/cross.gif");
    static Icon array_icon = Util.getIcon("/icons/datatree/array.gif");
