...
public class EditCopyAction extends EditClipAction {
    ...
    public EditCopyAction() {
        super(null, App.messages.getString("res.128"), getIcon("/icons/copy.gif"),
            getIcon("/icons/copy2.gif"));
    ...
    public EditCopyAction(ReportPanel reportPanel) {
        super(reportPanel, App.messages.getString("res.128"), getIcon("/icons/copy.gif"),
            getIcon("/icons/copy2.gif"));
        setStroke(ctrl(KeyEvent.VK_C));
    }
