...
public class EditDeleteAction extends EditClipAction {
    ...
    public EditDeleteAction() {
        super(null, App.messages.getString("res.96"), getIcon("/icons/delete.gif"),
            getIcon("/icons/delete2.gif"));
    ...
    public EditDeleteAction(ReportPanel panel) {
        super(panel, App.messages.getString("res.96"), getIcon("/icons/delete.gif"),
            getIcon("/icons/delete2.gif"));
        setStroke(key(KeyEvent.VK_DELETE));
    }
