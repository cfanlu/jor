...
public class PasteAction extends EditClipAction {
     ...
     */
    public PasteAction() {
        super(null, App.messages.getString("res.126"), getIcon("/icons/paste.gif"),
            getIcon("/icons/paste2.gif"));
    ...
    public PasteAction(ReportPanel panel) {
        super(panel, App.messages.getString("res.126"), getIcon("/icons/paste.gif"),
            getIcon("/icons/paste2.gif"));
        setStroke(ctrl(KeyEvent.VK_V));
    }
