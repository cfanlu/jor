...
class DatasetReaderSelectPanel extends JPanel {
    final static Icon DATASET_LIST = Util.getIcon("/icons/new.gif");
    final static Icon DATASET = Util.getIcon("/icons/open.gif");
    final static Icon ROWSET = Util.getIcon("/icons/save.gif");
    final static Icon COLUMNSET = Util.getIcon("/icons/print.gif");
    final static Icon SUMSET = Util.getIcon("/icons/print.gif");
    IconTree tree;
