...
public class ConnectionPanel {
    ...
    public ConnectionPanel(JPanel owner, GridBagConstraints gbc) {
        ...
        DropDownButton ddb = new DropDownButton(null, Util.getIcon("/icons/tree.gif"));
        ...
        //        
        //        bar.add(new FixedSizeButton(Util.getIcon("/icons/additem.gif"), null, 22, 22));
        //        bar.add(new FixedSizeButton(Util.getIcon("/icons/removeitem.gif"), null, 22, 22));
        ...
        JButton b = new JButton(App.messages.getString("res.81"), Util.getIcon("/icons/conn.gif"));
