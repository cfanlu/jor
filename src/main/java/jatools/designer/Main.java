...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        boldButton = new _IconToggleButton(Util.getIcon("/icons/_bold.gif"));
        italicButton = new _IconToggleButton(Util.getIcon("/icons/_italic.gif"));
        ...
        this.setIconImage(Util.getIcon("/icons/logo.png").getImage());
