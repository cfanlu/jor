...
public class DefaultReportsTreePanel extends JScrollPane {
    ...
    private JTree getDefaultReportsTree() {
        ...
        renderer.setLeafIcon(Util.getIcon("/icons/tmp.gif"));
        renderer.setOpenIcon(Util.getIcon("/icons/fldopen.gif"));
        renderer.setClosedIcon(Util.getIcon("/icons/fldclose.gif"));
