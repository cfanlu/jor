...
public class VariableTreeModel extends DefaultTreeModel implements TreeModelListener,
    ...
    static final Icon variableIcon = Util.getIcon("/icons/variable.gif");
    static final Icon fieldIcon = Util.getIcon("/icons/field.gif");
    static final Icon parameterIcon = Util.getIcon("/icons/parameter.gif");
    static final Icon formulaIcon = Util.getIcon("/icons/formula.gif");
    static final Icon commandIcon = Util.getIcon("/icons/command.gif");
    static final Icon sqlIcon = Util.getIcon("/icons/dataset.gif");
    static final Icon sysIcon = Util.getIcon("/icons/varsystem.gif");
    static final Icon componentIcon = Util.getIcon("/icons/component.gif");
