...
public class PropertyPanel extends JPanel implements ChangeListener, TooltipHelper {
    ...
    public PropertyPanel() {
        ...
        tp = new JTabbedPane();
        tp.addTab(App.messages.getString("res.300"), Util.getIcon("/icons/properties.gif"),
            new JScrollPane(propEditor));
        tp.addTab(App.messages.getString("res.301"), Util.getIcon("/icons/event.gif"), new JScrollPane(eventEditor));
        tp.addTab(App.messages.getString("res.205"), Util.getIcon("/icons/variable.gif"),
