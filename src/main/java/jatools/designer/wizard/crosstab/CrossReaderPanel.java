...
public class CrossReaderPanel extends JPanel implements ListSelectionListener, ChangeListener {
    ...
    public CrossReaderPanel() {
        ...
        upRowCommand = new JButton(Util.getIcon("/icons/moveup.gif")); //
        downRowCommand = new JButton(Util.getIcon("/icons/movedown.gif")); //
        ...
        upColCommand = new JButton(Util.getIcon("/icons/moveup.gif")); //
        downColCommand = new JButton(Util.getIcon("/icons/movedown.gif")); //
    ...
    private JButton createReleteButton() {
        Icon rdeleteButtonIcon = Util.getIcon("/icons/cross.gif"); //
    ...
    private JButton createCdeleteButton() {
        Icon cdeleteButtonIcon = Util.getIcon("/icons/cross.gif"); //
    ...
    private JButton createAdeleteButton() {
        Icon adeleteButtonIcon = Util.getIcon("/icons/cross.gif"); //
    ...
    private JButton createColumnButton() {
        Icon columnButtonIcon = Util.getIcon("/icons/toeast.gif"); //
    ...
    private JButton createRowButton() {
        Icon rowButtonIcon = Util.getIcon("/icons/tosouth.gif"); //
    ...
    private JButton createAggregationButton() {
        Icon aggregationButtonIcon = Util.getIcon("/icons/tosoutheast.gif"); //
