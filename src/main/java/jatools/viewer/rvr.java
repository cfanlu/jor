...
public class rvr extends JPanel implements ProtectPublic{
    ...
    public rvr(boolean showToolbar) {
        if (printIcon == null) {
            printIcon = new ImageIcon(this.getClass().getResource("/icons/print.gif")); //
        }
    ...
    JPanel buildToolbar() {
        ...
        icon = new ImageIcon(this.getClass().getResource("/icons/prevpage.gif")); //
        button = new JButton(icon);
        button.setPreferredSize(new Dimension(25, 25));
        button.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
        ...
        icon = new ImageIcon(this.getClass().getResource("/icons/nextpage.gif")); //
        button = new JButton(icon);
        button.setPreferredSize(new Dimension(25, 25));
        button.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
        ...
        toolbar.add(button);
        icon = new ImageIcon(this.getClass().getResource("/icons/lastpage.gif")); //
    ...
    void loadCursor() {
        ...
        try {
            icon = new ImageIcon(this.getClass().getResource("/icons/hand0.gif")); //
            ...
            icon = new ImageIcon(this.getClass().getResource("/icons/hand1.gif")); //
